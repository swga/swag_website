Studley Walton Gray Associates LLP Website
==========================================

This is SWGA website and application, we are starting the project on Angular2, looking at moving to Angular Universal for server side rendering when possible.
